...
* **Tipos de Pruebas:** Pruebas de API (Backend) | Pruebas UI | Pruebas Móviles | Pruebas de Regresión.
* **Estrategia:** Diseño de Casos de Prueba | Ciclo de Vida de Errores (Bug Hunting).
* **Arquitectura:** Page Object Model (POM) para automatización estructurada.
* **Enfoque Ágil:** Optimización de pruebas UI mediante mapas mentales y bloques atómicos.
---
